...
def train(sess, x, y, model, x_train, y_train,
  ...
  for epoch in xrange(200,args.nb_epochs):
    ...
    for batch in range(nb_batches):
      ...
      for dev_idx in xrange(num_devices):
        ...
        x_train_adv = attack.attack(sess,x_train_shuffled[cur_start:cur_end],y_train_shuffled[cur_start:cur_end] )
    ...
    saver.save(sess,'/nfs/nas4/data-hanwei/data-hanwei/DATA/models/cnn/ddn_adv_iter',global_step=epoch)
